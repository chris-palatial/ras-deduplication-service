...
COPY stage2_service.py handler.py artifact_upload.py artifact_contract.py point_cloud_glb.py object_catalog.py scene_parse_catalog.py best_view.py /app/
